...
pub(super) fn show_fft_panel(app: &mut ScopeAppMulti, ctx: &egui::Context) {
            ...
            egui::CollapsingHeader::new("FFT Settings").default_open(true).show(ui, |ui| {
                ui.horizontal(|ui| {
                    ...
                    egui::ComboBox::from_id_salt("fft_window_multi")
                        ...
                        .show_ui(ui, |ui| { for w in super::app::FftWindow::ALL { ui.selectable_value(&mut app.fft_window, *w, w.label()); } });
                    ui.separator();
